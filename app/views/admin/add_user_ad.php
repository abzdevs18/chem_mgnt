		...
		<div class="alerts-notif">
			<div class="alert-content no-fixed-height" style="border:1px solid #d5d5d5;">
				...
				<div class="changepass-holder">
					...
					<button class="tg-btn add-user-save-btn" type="button" data-usr="<?php echo $_SESSION['userName'];?>" style="padding:0px 40px;border-radius:3px;">Save <img src="/img/gif/save.gif" style="width: 20px;position: absolute;top: 25%;bottom: 0;right: 5px;display:none;" id="save-form"></button>
				</div>
			</div>
		</div>
	</section>
