...
<head>
    ...
    <style type="text/css">
    @import url("/css/static_style.css");
    </style>
    <!-- Pagination -->
    <script>
            ...
            <section id="side-navigation">
                ...
                <div id="navigation-scroll" data-simplebar>
                    <div id="logo-admin" dir="ltr">
                        <div>
                            <img src="/img/logo1.png" id="logo-icon">
                        </div>
                    </div>
                    ...
                    <nav>
                        <ul id="menus-nav">
                            <li data-link="/admin" class="menu-active">
                            ...
                            <li data-link="/admin/payments">
                                <i class="fal fa-shopping-cart"></i>
                                <a href="#"> Stocks</a>
                            </li>
                            <li data-link="/admin/favorites">
