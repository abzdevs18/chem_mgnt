	...
	<section class="main-tbl-container">
		<div class="tbl-wrap">
			...
			<div class="filter-category">
				<ul id="job-filters">
					<li class="active-filter">All Logs <span>(10)</span></li>
					<li>Login <span>(10)</span></li>
					<li>Requests <span>(10)</span></li>
					<li>Chemicals <span>(10)</span></li>
				</ul>
			</div>
